...
export default {
  ...
  computed: {
    text () {
      return this.$store.getters.headingText1
    },
    paragraph () {
      return this.$store.getters.paragraphText1
    }
  }
}
</script>
...
<style>
.bg-image {
  background-image: url("https://woolpackleicester.com/wp-content/uploads/2016/05/chilli-paneer.jpg");
